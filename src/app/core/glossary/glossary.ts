...
export const glossaryContent: GlossaryTab[] = [
  ...
  },
  {
    ...
    descriptions: [
      ...
      `Most heroic spells are only castable once per fight, forcing you to employ the strategy both during the battle and choice of abilities.`,
      ...
      `Mana is the resource that limits ability to cast spells for your hero and units. Units can have their own manapool, when drained - mana will be taken from their hero. As soon as mana is fully drained, abilities that require mana can no longer be cast.`,
