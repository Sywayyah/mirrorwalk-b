...
export const Firestorm = createSpell({
  ...
  getDescription: () => ({
    descriptions: [
      spellDescrElem(
        `Deals 100 damage to the target as fire damage while converting 30% of it to pure damage. Your current unit is going to suffer 25% of that damage as fire damage.`,
      ),
    ],
  }),
  config: {
