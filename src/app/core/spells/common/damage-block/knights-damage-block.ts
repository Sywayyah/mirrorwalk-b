...
export const TowerShieldsDamageBlock: SpellBaseType<{ damageBlockMod: Modifiers }> = createDamageBlockSpell({
  id: '#spell-tower-shields-block',
  name: 'Tower Shields',
  icon: 'heavy-shield',
  blockConfig: {
    minDamage: [14, 22, 34, 45, 120],
  ...
  description: ({ blockValue, meleeChance, rangedChance }) => `Tower shields can block ${blockValue} damage with ${meleeChance}% chance${rangedChanceDescription(meleeChance, rangedChance)}.`,
});
