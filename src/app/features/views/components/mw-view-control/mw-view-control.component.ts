...
import { DisplayReward, GameOpenMainScreen, GameOpenMapStructuresScreen, NeutralStructParams, OpenNewGameScreen, PlayerEntersTown, StructCompleted, StructFightConfirmed } from 'src/app/core/events';
