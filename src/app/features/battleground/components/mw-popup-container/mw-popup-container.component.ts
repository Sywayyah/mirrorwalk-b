...
import { FightEndsPopup, LossModel, PopupModel, PopupTypesEnum, ScriptedRewardPopup, StructHireRewardPopup, StructItemRewardPopup, StructRewardPopup } from 'src/app/core/ui';
